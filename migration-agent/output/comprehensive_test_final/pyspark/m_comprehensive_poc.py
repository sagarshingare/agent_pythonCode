...
class MComprehensivePoc:
    ...
    def execute(self):
        ...
        try:
            ...
            df_sq_customer_data = self.spark.read.csv("/data/sources/customer_data.csv", header=True, inferSchema=True)
            self.logger.info("Loaded source CUSTOMER_DATA: {} records".format(df_sq_customer_data.count()))
